...
#pdf("gesammt_vergleich.pdf")
# setwd("F:/FP_Data_Mining/R")
sink("./Vergleich/gesammt_vergleich.txt", append=TRUE)
...
wilcox.test(Sterne_cn, Sterne_de, alternative = "two.sided")
wilcox.test(Scores_cn, Scores_de, alternative = "two.sided")
