...
setwd("/Users/baier_2/Documents/Skripte/Data Mining im Marketing mit R/R/") 
# setwd("F:/FP_Data_Mining/R")

Daten <-read.csv("IKEA_gesamt.csv", header=TRUE, sep = ";")
n=dim(Daten)[1]
...
findAssocs(dtm,'funktioniert',0.30)
...
plot(dtm,
terms=findFreqTerms(dtm, lowfreq=10)[1:50],
corThreshold=0.1)
