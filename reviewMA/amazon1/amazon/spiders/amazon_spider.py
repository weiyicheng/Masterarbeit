...
class AmazonSpider(scrapy.Spider):
	name = "amazon"
	## product url hier
	URL_BEGIN = "http://www.amazon.de/product-reviews/B00HHVFM6C/ref=cm_cr_pr_top_link_"
	URL_FILTER = "?ie=UTF8&pageNumber="
	URL_END = "&showViewpoints=0&sortBy=byRankDescending"
	## wie viele Webseite fuer reviews gibt es
	pageNumber = 4
	start_urls = ["http://www.amazon.de/product-reviews/B00HHVFM6C/ref=cm_cr_pr_btm_link_1?ie=UTF8&showViewpoints=0&sortBy=byRankDescending"]
	# i=2
